#-----------------------------------------------------------------------------
# Name:        DlgAltaVocab.py
#
#
# RCS-ID:      $Id: DlgAltaVocab.py $
#
...
[wxID_DIALOG3, wxID_DIALOG3STATICTEXT1, wxID_DIALOG3STATICTEXT2, 
 wxID_DIALOG3TEXTCTRL1, wxID_DIALOG3TEXTCTRL2, 
...
class Dialog3(wx.Dialog):
    def _init_ctrls(self, prnt):
        ...
        wx.Dialog.__init__(self, id=wxID_DIALOG3, name='', parent=prnt,
              pos=wx.Point(421, 289), size=wx.Size(408, 256),
        ...
        self.staticText1 = wx.StaticText(id=wxID_DIALOG3STATICTEXT1,
              label='C\xf3digo', name='staticText1', parent=self,
              pos=wx.Point(48, 24), size=wx.Size(34, 13), style=0)
